...
function ProfilePage() {
  ...
  return (
    <div style={styles.container}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', paddingBottom: '10px', borderBottom: '2px solid #1890ff' }}>
        <h1 style={{ margin: 0, borderBottom: 'none', paddingBottom: 0 }}>Profil Bilgileri</h1>
        <button
